...
public class Utility {
	...
	public static String rpaging(int total, int nowPage, int recordPerPage, String col, String word, int bbsno,
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?col=" + col + "&bbsno=" + bbsno + "&nPage="
					+ _nPage + "&word=" + word + "&nowPage=" + nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?col=" + col + "&bbsno=" + bbsno + "&nPage="
						+ i + "&word=" + word + "&nowPage=" + nowPage + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?col=" + col + "&bbsno=" + bbsno + "&nPage="
					+ _nPage + "&word=" + word + "&nowPage=" + nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
