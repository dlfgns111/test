...
<FORM name='frm' method='POST' action='./create'
  ...
  <TABLE>
    <tr>
   	  ...
   	  <img alt="미리보기" src="${root }/gallery/storage/noimage.jpg" id="thumbnail_image" 
   	  >
   	</td>
   	</tr>
    <TR>    
      <TD><input type="file"  name="fnameMF" accept=".jpg,.png,.gif" onchange="getThumbnailPrivew(this, 'thumbnail_image'); " required="required"
></TD>
